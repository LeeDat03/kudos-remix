...
import { Color, Emoji, KudoStyle, User } from "@prisma/client";
...
export const loader: LoaderFunction = async ({ request, params }) => {
	// get user by session => author
	const user = await getUser(request);

	// get user by id in searchParams => recipient
	const { userId } = params;
...
export default function KudoModal() {
	...
	// results look like { name: "Red", value: "RED" }
	const getOptions = (data: Record<string, string>): Option[] =>
		Object.keys(data).reduce((acc: Option[], curr) => {
			acc.push({
